...
const MARQUEE_ITEMS_1 = [
  ...
  "VDF SEQUENTIAL", "DEPIN", "DESCI", "RIBOSOME NETWORK", "BLOCK #847K",
  "MAINNET LIVE", "ZUKER-STIEGLER", "McCASKILL", "BOUNDED DISCOUNT",
]

const MARQUEE_ITEMS_2 = [
  "OPEN SOURCE", "EVM COMPATIBLE", "INVERSE FOLDING", "DAO GOVERNED",
  "PHARMACEUTICAL R&D", "ACADEMIC CITATIONS", "12.5 $RIBO/BLOCK",
  "HALVING 2026", "VERIFIED ON-CHAIN", "CUDA SUPPORT", "ANTI-CANCER",
]
