...
const SUPPLY_SEGMENTS = [
  { label: "Mining Rewards",         pct: 99.9, color: "var(--accent)" },
...
const TOKEN_FACTS = [
  ...
  { label: "Block Reward",    val: "12.5 $RIBO" },
  { label: "Halving",         val: "Every 210,000 blocks" },
  { label: "Current Supply",  val: "847,291 $RIBO" },
  { label: "Standard",        val: "EVM-compatible" },
]

const HALVING = [
  { era: "Era 1", blocks: "0–210,000",      reward: "12.5 $RIBO",   current: true  },
  { era: "Era 2", blocks: "210,001–420,000", reward: "6.25 $RIBO",   current: false },
  { era: "Era 3", blocks: "420,001–630,000", reward: "3.125 $RIBO",  current: false },
  { era: "Era 4", blocks: "630,001–840,000", reward: "1.5625 $RIBO", current: false },
]
...
const UTILITIES = [
  ...
  "Pharmaceutical escrow collateral",
]
            ...
            <div className="flex flex-col">
              {TOKEN_FACTS.map((fact, i) => (
                ...
                >
                  ...
                  <span className="font-mono text-xs font-bold" style={{ color: "var(--fg)" }}>{fact.val}</span>
                </div>
              ))}
            </div>
          </Card>
                ...
                {HALVING.map((era, i) => (
                  <div
                    ...
                    style={{
                      ...
                      background: era.current ? "var(--accent-soft)" : "transparent",
                      margin: era.current ? "0 -8px" : 0,
                    }}
                  >
                    <div>
                      <div
                        className="font-mono text-xs font-bold"
                        style={{ color: era.current ? "var(--accent)" : "var(--fg)" }}
                      >
                        {era.era} {era.current && "← CURRENT"}
                      </div>
