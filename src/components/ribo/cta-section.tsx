...
export function CTASection() {
  ...
  const [role, setRole] = useState<"developer" | "researcher" | "miner">("developer")
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <div className="flex justify-center gap-2 mb-8">
          {(["developer", "researcher", "miner"] as const).map(r => (
            <button
              key={r}
              onClick={() => setRole(r)}
        ...
        <div className="mt-10 grid grid-cols-3 gap-0 max-w-md mx-auto">
          {[
            { v: "0",         l: "Tokens Minted" },
            { v: "0",         l: "Institutional Users" },
            { v: "v1.0",      l: "Spec Published" },
          ].map((s, i) => (
            <div
              key={i}
        ...
        <p
          className="mt-8 font-mono text-[10px] tracking-widest text-white/50 max-w-xl mx-auto"
        >
