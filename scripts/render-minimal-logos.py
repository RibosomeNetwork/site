#!/usr/bin/env python3
"""Render a contact sheet of all 12 minimal RIBO logos at three sizes:
- 200x200 (full size, dark bg)
- 200x200 (full size, light bg)
- 48x48 (favicon preview, dark bg)
- 16x16 (favicon preview, dark bg)

Output: /home/z/my-project/download/ribo-logos-minimal/contact-sheet.png
"""
import os

LOGOS_DIR = "/home/z/my-project/download/ribo-logos-minimal"
OUT_DIR = "/tmp/ribo-logo-minimal-render"
...
<style>
  ...
  .label { font-family: 'Space Mono', monospace; font-size: 9px; color: #8080A8; letter-spacing: 0.15em; margin-bottom: 4px; text-transform: uppercase; }
...
<h1>RIBO Minimal Logo Concepts — 12 marks · 3 size tests</h1>
<div class="grid">
"""
    ...
    <div class="cell">
      ...
      <div class="previews">
        <div>
          ...
          <div class="preview dark"><img src="{abs_path}"></div>
        </div>
        <div>
          <div class="label">LIGHT</div>
          <div class="preview light"><img src="{abs_path}"></div>
        </div>
      </div>
      <div class="favicons">
